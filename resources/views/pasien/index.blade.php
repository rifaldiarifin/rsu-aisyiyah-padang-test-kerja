...
@section('container')
<div class="col-lg-8">
    <h1 class="py-1 pb-3">Data Pasien</h1>
    <div class="my-3 d-flex justify-content-start">
        <a href="/pasien/create" class="btn btn-primary d-flex align-items-center  gap-2">
            ...
            @foreach ($pasien as $psn)
                <tr>
                    ...
                    <td class="d-flex gap-1">
                        <button type="button" class="btn btn-sm btn-show-data" data-href="/api/pasien/{{ $psn["id"] }}" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <i style="pointer-events: none" data-feather="info"></i>
                          </button>
                        <a class="btn btn-sm" href="/pasien/{{ $psn["id"] }}/edit">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h1 class="modal-title fs-5" id="exampleModalLabel">Info Pasien</h1>
